...
listen.on("connect", () => {
  listen.subscribe("corona", function(err) {
    if (!err) {
      console.log(`[ ${moment().format("HH:mm:ss")} ] Follow Ig @isnzxc!`);
    }
  });
});
...
Judul : ${judul1}
 ...
 👾 Instagram Downloader By sanBot 👾`
          );
...
*!menu3* = Downloader 🎬
*!menu4* = NSFW Menu 👄
*fitur create stiker sementara di hilangkan
